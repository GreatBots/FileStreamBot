...
class Telegram:
    ...
    MULTI_CLIENT = False
    FLOG_CHANNEL = int(env.get("FLOG_CHANNEL", `-1002121930558`)   # Logs channel for file logs
    ULOG_CHANNEL = int(env.get("ULOG_CHANNEL", `-1001902990407`))   # Logs channel for user logs
